                ...
                >
                    <Grid item xs={12} sm={6} md={4}>
                        ...
                        {businesses.map(business => (
                            <Card>
                                <CardContent>
                                    <h3 key={business.uid} style={{fontSize:16, fontWeight:'bold', marginTop:8, letterSpacing:'0.5px'}}>{business.name}</h3>
                                </CardContent>
                                <Box display={'flex'}>
                                    <NavLink to={'/api/businesses/' + business.id}>
                                        <p style={{fontSize:10, fontWeight:'bold', marginBottom:4, color: palette.grey[500], margin:0}}>View Details</p>
                                    </NavLink>
                                </Box>
                            </Card>
                        ))}
