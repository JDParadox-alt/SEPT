    ...
    render() {
        ...
        return (
            <div className="container">
                ...
                <Grid container spacing={2} direction="column" justify="flex-start" style={{ marginTop: '30px' }} >
                    <Grid item xs={12} >

                        {businesses.map(business => (
                            <Card>
                                <CardContent>
                                    <h3 key={business.uid}> Business Name: {business.name}</h3>
                                </CardContent>
                                <Box display={'flex'}>
                                    <NavLink to={'/api/businesses/' + business.uid}>
                                        <p>View Details</p>
                                    </NavLink>
                                </Box>
                            </Card>
